...
table = ttk.Treeview(window,columns=("ID","Last Name","First Name","Middle Name","Birth Year","Age"),show="headings")

for headings in ("ID","Last Name","First Name","Middle Name","Birth Year","Age"):
